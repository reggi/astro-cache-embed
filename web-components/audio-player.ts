...
import './input-slider.js'
import './play-icon.js'
import './pause-icon.js'
import './volume-off-icon.js'
import './volume-high-icon.js'
import './download-icon.js'
...
export class AudioPlayer extends HTMLElement {
  ...
  initVolumeSlider () {
    ...
    this.volumeContainer.style.paddingTop = '10px'
